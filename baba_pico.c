...
// Estado 
bool system_active = 0;
bool melody_active = 0;

// Inicializando o buzzer pra PWM
...
// configuracao dos leds (inicializacao e direcao)
void configure_leds() {
...
// Acionar uma nota com frequência e duração específicas
